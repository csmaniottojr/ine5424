...
void TSTP::Locator::bootstrap()
{
    ...
    if(Traits<TSTP>::sink)
        ...
        static int x = COORDINATE_X;
        static int y = COORDINATE_Y;
        static int z = COORDINATE_Z;

        _here = Coordinates(x,y,z); // Adjust this value to the coordinates of the sensor
    }
