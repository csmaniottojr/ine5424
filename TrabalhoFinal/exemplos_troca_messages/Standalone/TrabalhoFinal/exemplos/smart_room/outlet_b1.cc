...
const char Traits<Build>::ID[Traits<Build>::ID_SIZE] = {'B','1'};
const unsigned char MODBUS_ID = 0xB1;
        ...
        switch(cmd) {
            case READ_HOLDING_REGISTER:
                ...
                switch(starting_address) {
                    default:
                    case 0: payload[idx++] = htons(sense_power0());
                        break;
                    case 1:
                        payload[idx++] = htons(sense_power1());
                        break;
                }
