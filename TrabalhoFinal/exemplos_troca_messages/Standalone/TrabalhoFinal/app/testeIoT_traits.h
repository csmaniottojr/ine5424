...
template<> struct Traits<System> : public Traits<void>
{
    ...
    enum
    {
        FOREVER = 0, SECOND = 1, MINUTE = 60, HOUR = 3600, DAY = 86400, WEEK = 604800, MONTH = 2592000, YEAR = 31536000
    };
...
{
    static const bool enabled = ( Traits<Build>::NODES > 0 );
...
template<> struct Traits<TSTP> : public Traits<Network>
{
    ...
    static const int coordinateX = 1;
    static const int coordinateY = 1;
    static const int coordinateZ = 1;
};
