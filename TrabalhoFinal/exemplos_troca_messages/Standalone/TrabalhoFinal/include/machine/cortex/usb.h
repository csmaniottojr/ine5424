...
public:
    ...
    static bool ready_to_put ( ) {
        return _ready_to_put;
    }
...
private:
    ...
    static bool configured ( ) {
        return state ( ) >= USB_2_0::STATE::CONFIGURED;
    }

    static void endpoint ( int index ) {
        reg ( INDEX ) = index;
    }
...
protected:
    ...
    static volatile Reg32 & reg ( unsigned int offset ) {
        return *( reinterpret_cast < volatile Reg32* > ( USB_BASE + offset ) );
    }
